              ...
              <div className={cx("main-menu")}>
                <ul className={cx("menu")}>
                  <li class={cx("dropdown")}>
                    <Link to={config.clientsRoutes.allJob} title="Tìm việc làm">
                      Tìm việc làm
                    </Link>
            ...
            <a title="Đăng nhập" onClick={redirectLogin} >
              ...
              {!currentUser ? (
                <>
                  ...
                  <div className={cx("main-login", "dropdown")}>
                    <div className={cx("title-login")}>
                      <Link to={config.clientsRoutes.login} title="Đăng nhập">
                        <AccountCircleIcon
                  ...
                  <div className={cx("main-register")}>
                    <Link to={config.clientsRoutes.register} title="Đăng ký">
                      Đăng ký
                    </Link>
                  </div>
                </>
                ...
                <div className={cx("main-login", "logged", "dropdown")}>
                  <Link to={config.clientsRoutes.dashboard} rel="nofollow">
                     <AccountCircleIcon
                          sx={{ fontSize: 20, paddingRight: "5px" }}
                     />
                    Chào
                  ...
                  <div className={cx("dropdown-menu")}>
                    <ul>
                      <li>
                        <Link to={config.clientsRoutes.dashboard} >
                          Quản Lý Hồ Sơ
                        </Link>
                      </li>
                      <li>
                        <Link to={config.clientsRoutes.myProfile} >
                          Hồ sơ của tôi
                        </Link>
                      </li>
                      <li>
